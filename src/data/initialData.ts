...
export const initialState: AppState = {
  ...
  domains: [
    { id: 1, name: 'AI Governance', icon: '🏛️', notes: [] },
    { id: 2, name: 'AI Risk Management', icon: '⚠️', notes: [] },
    { id: 3, name: 'AI Development & Implementation', icon: '🔧', notes: [] },
    { id: 4, name: 'AI Operations & Monitoring', icon: '⚙️', notes: [] },
  ],
  quizAttempts: [],
  studySessions: [],
  examDate: null,
