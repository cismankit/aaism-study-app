  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <section className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5 space-y-3">
        ...
        <ul className="text-xs space-y-1.5 font-mono text-gray-500 dark:text-gray-400">
      ...
      <section className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5 space-y-3">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          or local Ollama. API keys live in <code className="text-xs bg-gray-100 dark:bg-gray-700 px-1 rounded">{AI_CONFIG_STORAGE_KEY}</code> and are never transmitted to AAISM infrastructure.
        </p>
        <p className="text-sm text-gray-600 dark:text-gray-400">
      ...
      <section className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5 space-y-3">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">
          Live Intel Feed fetches curated security RSS sources via public read-only proxies (e.g. rss2json.com) from your browser. Headlines and summaries are cached locally under <code className="text-xs bg-gray-100 dark:bg-gray-700 px-1 rounded">aaism_rss_cache</code> for up to 30 minutes. No account or tracking is required.
        </p>
        <p className="text-sm text-gray-600 dark:text-gray-400">
